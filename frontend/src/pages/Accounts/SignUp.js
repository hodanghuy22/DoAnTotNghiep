      ...
      <div className='d-flex w-75 m-auto shadow p-3 mb-5 bg-body rounded'>
        ...
        <div className='p-4 '>
          ...
          <form className='d-flex flex-column'>
            <input type='text' placeholder='Họ và tên' className='w-100 shadow p-3 mb-4 bg-body rounded' />
            <input type='password' placeholder='Số điện thoại' className='w-100 shadow p-3 mb-3 bg-body rounded' />
            <input type='password' placeholder='Nhập địa chỉ email' className='w-100 shadow p-3 mb-3 bg-body rounded' />
